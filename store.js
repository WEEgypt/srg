  ...
  if (localStorage.getItem("stores") > "1") {
    ...
    for (i = 1; i <= x; i++) {
      ...
      document
        ...
        .options.add(
          new Option(localStorage.getItem("storename.store." + value), value)
        );
    }
    document
      .getElementById("stores")
      .options.add(new Option("Add Another Store", "newstore"));
  }
...
function Back__3() {
  if (
    ...
    localStorage.getItem("activeStores") > "1" &&
    sessionStorage.getItem("newstore") == "true"
  ) {
    basic.style.display = "none";
    multi.style.display = "block";
    document.getElementById("stores").innerHTML = "";
...
function Continue() {
  ...
  row__2.style.display = "none";
  today.style.display = "block";
  document.getElementById("storename").value = localStorage.getItem(
    "storename.store." + x
  );
  document.getElementById("achievedpayg").value = localStorage.getItem(
    "achievedpayg.store." + x
  );
  document.getElementById("targetpayg").value = localStorage.getItem(
    "targetpayg.store." + x
  );
  document.getElementById("achieveddata").value = localStorage.getItem(
    "achieveddata.store." + x
  );
  document.getElementById("targetdata").value = localStorage.getItem(
    "targetdata.store." + x
  );
  document.getElementById("achievedsuperkix").value = localStorage.getItem(
    "achievedsuperkix.store." + x
  );
  document.getElementById("targetsuperkix").value = localStorage.getItem(
    "targetsuperkix.store." + x
  );
  document.getElementById("achievedtaz").value = localStorage.getItem(
    "achievedtaz.store." + x
  );
  document.getElementById("targettaz").value = localStorage.getItem(
    "targettaz.store." + x
  );
  document.getElementById("achievedweclub").value = localStorage.getItem(
    "achievedweclub.store." + x
  );
  document.getElementById("targetweclub").value = localStorage.getItem(
    "targetweclub.store." + x
  );
  document.getElementById("achievedwemix").value = localStorage.getItem(
    "achievedwemix.store." + x
  );
  document.getElementById("targetwemix").value = localStorage.getItem(
    "targetwemix.store." + x
  );
  document.getElementById("achievedwegoldfmc").value = localStorage.getItem(
    "achievedwegoldfmc.store." + x
  );
  document.getElementById("achievedwegoldsa").value = localStorage.getItem(
    "achievedwegoldsa.store." + x
  );
  document.getElementById("targetwegold").value = localStorage.getItem(
    "targetwegold.store." + x
  );
  document.getElementById("achievedadsl140").value = localStorage.getItem(
    "achievedadsl140.store." + x
  );
  document.getElementById("achievedadslht").value = localStorage.getItem(
    "achievedadslht.store." + x
  );
  document.getElementById("targetadsl").value = localStorage.getItem(
    "targetadsl.store." + x
  );
  document.getElementById("achievedfixed").value = localStorage.getItem(
    "achievedfixed.store." + x
  );
  document.getElementById("targetfixed").value = localStorage.getItem(
    "targetfixed.store." + x
  );
  document.getElementById("achievedwallet").value = localStorage.getItem(
    "achievedwallet.store." + x
  );
  document.getElementById("targetwallet").value = localStorage.getItem(
    "targetwallet.store." + x
  );
...
function GenerateSalesReport() {
  ...
  todaysuperkix =
    todaysuperkix25 +
      ...
      todaysuperkix130 || 0;
  achievedsuperkix =
    parseInt(document.getElementById("achievedsuperkix").value) || 0;
  utdsuperkix =
    todaysuperkix25 +
      todaysuperkix32 +
      todaysuperkix45 +
      ...
      achievedsuperkix || 0;
  targetsuperkix =
    parseInt(document.getElementById("targetsuperkix").value) || 0;
  todaytazbeet40Input = document
    .getElementById("todaytazbeet40")
    .value.split(" ");
  todaytazbeet40 = 0;
  for (i = 0; i < todaytazbeet40Input.length; i++) {
    todaytazbeet40 += parseInt(todaytazbeet40Input[i]) || 0;
  }
  todaytazbeet50Input = document
    .getElementById("todaytazbeet50")
    .value.split(" ");
  todaytazbeet50 = 0;
  for (i = 0; i < todaytazbeet50Input.length; i++) {
    todaytazbeet50 += parseInt(todaytazbeet50Input[i]) || 0;
  }
  todaytazbeet90Input = document
    .getElementById("todaytazbeet90")
    .value.split(" ");
  todaytazbeet90 = 0;
  for (i = 0; i < todaytazbeet90Input.length; i++) {
    todaytazbeet90 += parseInt(todaytazbeet90Input[i]) || 0;
  }
  todaytazbeet145Input = document
    .getElementById("todaytazbeet145")
    .value.split(" ");
  todaytazbeet145 = 0;
  ...
  todaytazbeet =
    todaytazbeet40 + todaytazbeet50 + todaytazbeet90 + todaytazbeet145 || 0;
  ...
  todayweclub =
    todayweclub32 + todayweclub50 + todayweclub85 + todayweclub130 || 0;
  achievedweclub =
    parseInt(document.getElementById("achievedweclub").value) || 0;
  utdweclub =
    todayweclub32 +
      todayweclub50 +
      todayweclub85 +
  ...
  todaywemix215Input = document
    .getElementById("todaywemix215")
    .value.split(" ");
  todaywemix215 = 0;
  for (i = 0; i < todaywemix215Input.length; i++) {
    todaywemix215 += parseInt(todaywemix215Input[i]) || 0;
  }
  todaywemix310Input = document
    .getElementById("todaywemix310")
    .value.split(" ");
  todaywemix310 = 0;
  ...
  achievedwegoldfmc =
    parseInt(document.getElementById("achievedwegoldfmc").value) || 0;
  achievedwegoldsa =
    parseInt(document.getElementById("achievedwegoldsa").value) || 0;
  ...
  todayadsl1000Input = document
    .getElementById("todayadsl1000")
    .value.split(" ");
  todayadsl1000 = 0;
  for (i = 0; i < todayadsl1000Input.length; i++) {
    todayadsl1000 += parseInt(todayadsl1000Input[i]) || 0;
  }
  todayadsl1500Input = document
    .getElementById("todayadsl1500")
    .value.split(" ");
  todayadsl1500 = 0;
  for (i = 0; i < todayadsl1500Input.length; i++) {
    todayadsl1500 += parseInt(todayadsl1500Input[i]) || 0;
  }
  todayadslannualInput = document
    .getElementById("todayadslannual")
    .value.split(" ");
  todayadslannual = 0;
  ...
  achievedadsl140 =
    parseInt(document.getElementById("achievedadsl140").value) || 0;
  achievedadslht =
    parseInt(document.getElementById("achievedadslht").value) || 0;
  ...
  achievedwallet =
    parseInt(document.getElementById("achievedwallet").value) || 0;
  ...
  reMobile =
    ~~Number(
      Math.round((((utdmobile / targetmobile) * 100) / day) * daysinmonth)
    ) || 0;
  dailyrequired =
    ~~Number(Math.ceil((targetmobile - utdmobile) / (daysinmonth - day))) || 0;
  ...
  dailyrequiredGold =
    ~~Number(Math.ceil((targetwegold - utdwegold) / (daysinmonth - day))) || 0;
  ...
  dailyrequiredWallet =
    ~~Number(Math.ceil((targetwallet - utdwallet) / (daysinmonth - day))) || 0;
...
function Print__1() {
  ...
  doc.document.open();
  doc.document.write(
    "<html lang=en><head><title>Sales Report</title><style>body {font-family: monospace; display: flex;} div {margin: 0px auto 0px auto;}</style></head><body><div>"
  );
  doc.document.write(
    document
      .getElementById("salesreport")
      .value.replace(/  /gi, "&nbsp;&nbsp;")
      .replace(/\n/gi, "<br>")
  );
...
function Print__2() {
  ...
  doc.document.open();
  doc.document.write(
    "<html lang=en><head><title>Summarized Report</title><style>body {font-family: monospace; display: flex;} div {margin: 0px auto 0px auto;}</style></head><body><div>"
  );
  doc.document.write(
    document
      .getElementById("summarizedreport")
      .value.replace(/  /gi, "&nbsp;&nbsp;")
      .replace(/\n/gi, "<br>")
  );
  doc.document.write("</div></body></html>");
...
function Save__1() {
  ...
  localStorage.setItem(
    "storename.store." + x,
    document.getElementById("storename").value || "Store " + x
  );
  ...
  localStorage.setItem(
    "activeStores",
    localStorage.getItem("stores") - localStorage.getItem("removedStores")
  );
}
function Save__2() {
  Save__1();
...
function RemoveStore() {
  ...
  let text =
    ...
    '"' +
    localStorage.getItem("storename.store." + x) +
    '"?';
  if (confirm(text) == true) {
    ...
    localStorage.setItem(
      "removedStores",
      parseInt(localStorage.getItem("removedStores")) + 1 || 1
    );
    if (localStorage.getItem("activeStores") < "1") {
