function EnableRestore() {
    if (localStorage.getItem("enableRestore") == "true") {
        basic.style.display = "none";
        restore.style.display = "block";
        row1.style.display = "none";
        row2.style.display = "block";
        users.style.display = "block";
        document.getElementById("user1").innerHTML = localStorage.getItem("yourname.1");
        let x = localStorage.getItem("users");
        for (i = 0; i < x - 1; i++) {
            var value = parseInt([i]) + 2;
            document.getElementById("users").options.add(new Option(localStorage.getItem("yourname." + value), value));
        }
...
function Continue1() {
    ...
    document.getElementById("yourname").value = localStorage.getItem("yourname." + x);
    document.getElementById("achievedpayg").value = localStorage.getItem("achievedpayg." + x);
    document.getElementById("targetpayg").value = localStorage.getItem("targetpayg." + x);
    document.getElementById("achieveddata").value = localStorage.getItem("achieveddata." + x);
    document.getElementById("targetdata").value = localStorage.getItem("targetdata." + x);
    document.getElementById("achievedkixandsuper").value = localStorage.getItem("achievedkixandsuper." + x);
    document.getElementById("achievedtaz").value = localStorage.getItem("achievedtaz." + x);
    document.getElementById("targetkixandsuper").value = localStorage.getItem("targetkixandsuper." + x);
    document.getElementById("targettaz").value = localStorage.getItem("targettaz." + x);
    document.getElementById("achievedweclub").value = localStorage.getItem("achievedweclub." + x);
    document.getElementById("targetweclub").value = localStorage.getItem("targetweclub." + x);
    document.getElementById("achievedwemix").value = localStorage.getItem("achievedwemix." + x);
    document.getElementById("targetwemix").value = localStorage.getItem("targetwemix." + x);
    document.getElementById("achievedindigo").value = localStorage.getItem("achievedindigo." + x);
    document.getElementById("targetindigo").value = localStorage.getItem("targetindigo." + x);
    document.getElementById("achievedtkafol").value = localStorage.getItem("achievedtkafol." + x);
    document.getElementById("achievedadsl").value = localStorage.getItem("achievedadsl." + x);
    document.getElementById("targetadsl").value = localStorage.getItem("targetadsl." + x);
    document.getElementById("achievedfixed").value = localStorage.getItem("achievedfixed." + x);
    document.getElementById("targetfixed").value = localStorage.getItem("targetfixed." + x);
    document.getElementById("achievedmifi").value = localStorage.getItem("achievedmifi." + x);
    document.getElementById("targetmifi").value = localStorage.getItem("targetmifi." + x);
...
function Save1() {
    ...
    localStorage.setItem("yourname." + x, document.getElementById("yourname").value || "User " + x);
    localStorage.setItem("achievedpayg." + x, document.getElementById("achievedpayg").value);
    localStorage.setItem("targetpayg." + x, document.getElementById("targetpayg").value);
    localStorage.setItem("achieveddata." + x, document.getElementById("achieveddata").value);
    localStorage.setItem("targetdata." + x, document.getElementById("targetdata").value);
    localStorage.setItem("achievedkixandsuper." + x, document.getElementById("achievedkixandsuper").value);
    localStorage.setItem("achievedtaz." + x, document.getElementById("achievedtaz").value);
    localStorage.setItem("targetkixandsuper." + x, document.getElementById("targetkixandsuper").value);
    localStorage.setItem("targettaz." + x, document.getElementById("targettaz").value);
    localStorage.setItem("achievedweclub." + x, document.getElementById("achievedweclub").value);
    localStorage.setItem("targetweclub." + x, document.getElementById("targetweclub").value);
    localStorage.setItem("achievedwemix." + x, document.getElementById("achievedwemix").value);
    localStorage.setItem("targetwemix." + x, document.getElementById("targetwemix").value);
    localStorage.setItem("achievedindigo." + x, document.getElementById("achievedindigo").value);
    localStorage.setItem("targetindigo." + x, document.getElementById("targetindigo").value);
    localStorage.setItem("achievedtkafol." + x, document.getElementById("achievedtkafol").value);
    localStorage.setItem("achievedadsl." + x, document.getElementById("achievedadsl").value);
    localStorage.setItem("targetadsl." + x, document.getElementById("targetadsl").value);
    localStorage.setItem("achievedfixed." + x, document.getElementById("achievedfixed").value);
    localStorage.setItem("targetfixed." + x, document.getElementById("targetfixed").value);
    localStorage.setItem("achievedmifi." + x, document.getElementById("achievedmifi").value);
    localStorage.setItem("targetmifi." + x, document.getElementById("targetmifi").value);
    document.getElementById("save1").disabled = true;
    document.getElementById("save2").disabled = true;
    localStorage.setItem("enableRestore", "true");
...
function Print1() {
    ...
    doc.document.open();
    doc.document.write("<html><head><title>Sales Report</title></head><body>");
