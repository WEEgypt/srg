  ...
  if (localStorage.getItem("areas") > "1") {
    ...
    for (i = 1; i <= x; i++) {
      ...
      document
        ...
        .options.add(
          new Option(localStorage.getItem("areaname.area." + value), value)
        );
    }
    document
      .getElementById("areas")
      .options.add(new Option("Add Another Area", "newarea"));
  }
...
function Back__3() {
  if (
    ...
    localStorage.getItem("activeAreas") > "1" &&
    sessionStorage.getItem("newarea") == "true"
  ) {
    basic.style.display = "none";
    multi.style.display = "block";
    document.getElementById("areas").innerHTML = "";
...
function Continue() {
  ...
  row__2.style.display = "none";
  today.style.display = "block";
  document.getElementById("areaname").value = localStorage.getItem(
    "areaname.area." + x
  );
  document.getElementById("achievedmobile").value = localStorage.getItem(
    "achievedmobile.area." + x
  );
  document.getElementById("targetmobile").value = localStorage.getItem(
    "targetmobile.area." + x
  );
  document.getElementById("achievedwegold").value = localStorage.getItem(
    "achievedwegold.area." + x
  );
  document.getElementById("targetwegold").value = localStorage.getItem(
    "targetwegold.area." + x
  );
  document.getElementById("achievedadsl").value = localStorage.getItem(
    "achievedadsl.area." + x
  );
...
function GenerateSalesReport() {
  ...
  achievedmobile =
    parseInt(document.getElementById("achievedmobile").value) || 0;
  ...
  achievedwegold =
    parseInt(document.getElementById("achievedwegold").value) || 0;
...
function Print__1() {
  ...
  doc.document.open();
  doc.document.write(
    "<html lang=en><head><title>Area Report</title><style>body {font-family: monospace; display: flex;} div {margin: 0px auto 0px auto;}</style></head><body><div>"
  );
  doc.document.write(
    document
...
function Save__1() {
  ...
  localStorage.setItem(
    "areaname.area." + x,
    document.getElementById("areaname").value || "Area " + x
  );
  ...
  localStorage.setItem(
    "activeAreas",
    localStorage.getItem("areas") - localStorage.getItem("removedAreas")
  );
}
function Save__2() {
  Save__1();
...
function RemoveArea() {
  ...
  let text =
    ...
    '"' +
    localStorage.getItem("areaname.area." + x) +
    '"?';
  if (confirm(text) == true) {
    ...
    localStorage.setItem(
      "removedAreas",
      parseInt(localStorage.getItem("removedAreas")) + 1 || 1
    );
    if (localStorage.getItem("activeAreas") < "1") {
