  ...
  if (localStorage.getItem("users") > "1") {
    ...
    for (i = 1; i <= x; i++) {
      ...
      document
        ...
        .options.add(
          new Option(localStorage.getItem("yourname.agent." + value), value)
        );
    }
    document
      .getElementById("users")
      .options.add(new Option("Add Another Agent", "newuser"));
  }
...
function Back__3() {
  if (
    ...
    localStorage.getItem("activeUsers") > "1" &&
...
function Continue() {
  ...
  row__2.style.display = "none";
  today.style.display = "block";
  document.getElementById("yourname").value = localStorage.getItem(
    "yourname.agent." + x
  );
  document.getElementById("achievedpayg").value = localStorage.getItem(
    "achievedpayg.agent." + x
  );
...
function NewUser() {
  ...
  x = users + 1;
  y = parseInt(localStorage.getItem("selectedUser"));
...
function Save__1() {
  ...
  localStorage.setItem(
    "yourname.agent." + x,
    document.getElementById("yourname").value || "Agent " + x
  );
  ...
  localStorage.setItem(
    "activeUsers",
    localStorage.getItem("users") - localStorage.getItem("removedUsers")
  );
}
function Save__2() {
  Save__1();
...
function RemoveUser() {
  ...
  let text =
    ...
    '"' +
    localStorage.getItem("yourname.agent." + x) +
    '"?';
  if (confirm(text) == true) {
    ...
    localStorage.setItem(
      "removedUsers",
      parseInt(localStorage.getItem("removedUsers")) + 1 || 1
    );
    if (localStorage.getItem("activeUsers") < "1") {
