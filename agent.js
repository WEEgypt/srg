...
function Continue() {
    ...
    document.getElementById("achievedweair").value = localStorage.getItem("achievedweair.agent." + x);
    document.getElementById("achievedmifi").value = localStorage.getItem("achievedmifi.agent." + x);
    ...
    document.getElementById("todaywesonic").value = "";
    document.getElementById("todaywelife").value = "";
...
function NewUser() {
    ...
    document.getElementById("achievedpayg").value = "";
    document.getElementById("targetpayg").value = localStorage.getItem("targetpayg.agent." + y);
    document.getElementById("achieveddata").value = "";
    document.getElementById("targetdata").value = localStorage.getItem("targetdata.agent." + y);
    document.getElementById("achievedsuperkix").value = "";
    document.getElementById("targetsuperkix").value = localStorage.getItem("targetsuperkix.agent." + y);
    document.getElementById("achievedtaz").value = "";
    document.getElementById("targettaz").value = localStorage.getItem("targettaz.agent." + y);
    document.getElementById("achievedweclub").value = "";
    document.getElementById("targetweclub").value = localStorage.getItem("targetweclub.agent." + y);
    document.getElementById("achievedwemix").value = "";
    document.getElementById("targetwemix").value = localStorage.getItem("targetwemix.agent." + y);
    document.getElementById("achievedwegoldfmc").value = "";
    document.getElementById("achievedwegoldsa").value = "";
    document.getElementById("targetwegold").value = localStorage.getItem("targetwegold.agent." + y);
    document.getElementById("achievedadsl140").value = "";
    document.getElementById("achievedadslht").value = "";
    document.getElementById("targetadsl").value = localStorage.getItem("targetadsl.agent." + y);
    document.getElementById("achievedfixed").value = "";
    document.getElementById("targetfixed").value = localStorage.getItem("targetfixed.agent." + y);
    document.getElementById("achievedwallet").value = "";
    document.getElementById("targetwallet").value = localStorage.getItem("targetwallet.agent." + y);
    document.getElementById("achievedweair").value = "";
    document.getElementById("achievedmifi").value = "";
    document.getElementById("todaypayg").value = "";
    document.getElementById("todaydata").value = "";
...
function GenerateSalesReport() {
    ...
    todaywesonicInput = document.getElementById("todaywesonic").value.split(" ");
    todaywesonic = 0;
    for (i = 0; i < todaywesonicInput.length; i++) {
        todaywesonic += parseInt(todaywesonicInput[i]) || 0;
    }
    todaywelifeInput = document.getElementById("todaywelife").value.split(" ");
    todaywelife = 0;
    for (i = 0; i < todaywelifeInput.length; i++) {
        todaywelife += parseInt(todaywelifeInput[i]) || 0;
    }
    todayadsl140 = todayadsl140 || 0;
    todayadslht = todayadsl200 + todayadsl250 + todayadsl400 + todayadsl600 + todayadsl1000 + todayadslannual + todaywesonic + todaywelife || 0;
    ...
    var todaysalesArray = [
        ...
        todaywesonic.toString(),
        todaywelife.toString(),
        todayfixed.toString(),
    ...
    todayadsl400Adjusted = todaysalesArrayAdjusted[34];
    todayadsl600Adjusted = todaysalesArrayAdjusted[35];
    todayadsl1000Adjusted = todaysalesArrayAdjusted[36];
    todayadslannualAdjusted = todaysalesArrayAdjusted[37];
    todaywesonicAdjusted = todaysalesArrayAdjusted[38];
    todaywelifeAdjusted = todaysalesArrayAdjusted[39];
    todayfixedAdjusted = todaysalesArrayAdjusted[40];
    todaywalletAdjusted = todaysalesArrayAdjusted[41];
    todayweairAdjusted = todaysalesArrayAdjusted[42];
    todaymifiAdjusted = todaysalesArrayAdjusted[43];
    if (todaypayg == "0") {
        todaypaygreport = "";
    ...
    if (todaywesonic == "0") {
        todaywesonicreport = "";
        todaywesonicreportForSharing = "";
    } else {
        todaywesonicreport = "\n" + todaywesonicAdjusted + " * We Sonic";
        todaywesonicreportForSharing = "\n" + "```" + todaywesonicAdjusted + "```" + " * We Sonic";
    }
    if (todaywelife == "0") {
        todaywelifereport = "";
        todaywelifereportForSharing = "";
    } else {
        todaywelifereport = "\n" + todaywelifeAdjusted + " * We Life";
        todaywelifereportForSharing = "\n" + "```" + todaywelifeAdjusted + "```" + " * We Life";
    }
    if (todayfixed == "0") {
        todayfixedreport = "";
...
function Save__1() {
    ...
    localStorage.setItem("achievedweair.agent." + x, utdweair);
    localStorage.setItem("achievedmifi.agent." + x, utdmifi);
...
function RemoveUser() {
    ...
    if (confirm(text) == true) {
        ...
        localStorage.removeItem("achievedweair.agent." + x);
        localStorage.removeItem("achievedmifi.agent." + x);
